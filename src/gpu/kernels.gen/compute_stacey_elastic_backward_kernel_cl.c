...
#endif\n\
\n\
__kernel void compute_stacey_elastic_backward_kernel(__global float * b_accel, const __global float * b_absorb_field, const int num_abs_boundary_faces, const __global int * abs_boundary_ispec, const __global int * abs_boundary_npoin, const __global int * abs_boundary_ijk, const __global int * ibool){\n\
  int npoin;\n\
  int igll;\n\
  int iface;\n\
  int i;\n\
