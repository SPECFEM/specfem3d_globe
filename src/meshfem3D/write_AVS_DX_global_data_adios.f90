...
subroutine define_AVS_DX_global_data_adios(adios_group, myrank, nspec, ibool, &
  ...
  call define_adios_global_array1D(adios_group, group_size_inc, npoin, &
                                   '\0', "points/x_value", dummy_real1d)
  call define_adios_global_array1D(adios_group, group_size_inc, npoin, &
                                   '\0', "points/y_value", dummy_real1d)
  call define_adios_global_array1D(adios_group, group_size_inc, npoin, &
                                   '\0', "points/z_value", dummy_real1d)

  !--- Variables for AVS_DXelements.txt
  call define_adios_global_array1D(adios_group, group_size_inc, nspec, &
                                   '\0', "elements/idoubling", dummy_int1d)

  call define_adios_global_array1D(adios_group, group_size_inc, nspec, &
                                   '\0', "elements/num_ibool_AVS_DX_iglob1", dummy_int1d)
  call define_adios_global_array1D(adios_group, group_size_inc, nspec, &
                                   '\0', "elements/num_ibool_AVS_DX_iglob2", dummy_int1d)
  call define_adios_global_array1D(adios_group, group_size_inc, nspec, &
                                   '\0', "elements/num_ibool_AVS_DX_iglob3", dummy_int1d)
  call define_adios_global_array1D(adios_group, group_size_inc, nspec, &
                                   '\0', "elements/num_ibool_AVS_DX_iglob4", dummy_int1d)
  call define_adios_global_array1D(adios_group, group_size_inc, nspec, &
                                   '\0', "elements/num_ibool_AVS_DX_iglob5", dummy_int1d)
  call define_adios_global_array1D(adios_group, group_size_inc, nspec, &
                                   '\0', "elements/num_ibool_AVS_DX_iglob6", dummy_int1d)
  call define_adios_global_array1D(adios_group, group_size_inc, nspec, &
                                   '\0', "elements/num_ibool_AVS_DX_iglob7", dummy_int1d)
  call define_adios_global_array1D(adios_group, group_size_inc, nspec, &
                                   '\0', "elements/num_ibool_AVS_DX_iglob8", dummy_int1d)
