...
!> Writes the ASDF data structure to the file
  ...
  use constants_solver, only: NDIM,itag,MAX_LENGTH_NETWORK_NAME,MAX_LENGTH_STATION_NAME, &
...
!  use iso_Fortran_env
  ...
  nsamples = ceiling(real(NSTEP) / NTSTEP_BETWEEN_OUTPUT_SAMPLE) ! BS BS: The total number of samples to be written to the
