...
! code to check that all the 1D buffers between chunk corners are okay
  ...
  integer icodemaster,icodeslave1,icodeslave2
...
! check all the points based upon their coordinates
  ...
  read(34,*) iboolmaster,icodemaster,xmaster,ymaster,zmaster
  read(35,*) iboolslave1,icodeslave1,xslave1,yslave1,zslave1
  read(36,*) iboolslave2,icodeslave2,xslave2,yslave2,zslave2
  ...
  if(icodemaster /= icodeslave1 .or. icodemaster /= icodeslave2 &
        .or. icodeslave1 /= icodeslave2) stop 'error: different codes'
