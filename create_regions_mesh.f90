...
! arrays locval(npointot) and ifseg(npointot) used to save memory
  call get_MPI_cutplanes_xi(myrank,prname,nspec,iMPIcut_xi,ibool,idoubling, &
                  xstore,ystore,zstore,ifseg,ichunk,npointot, &
                  NSPEC2D_A_ETA,NSPEC2D_B_ETA,NSPEC2D_C_ETA)
  call get_MPI_cutplanes_eta(myrank,prname,nspec,iMPIcut_eta,ibool,idoubling, &
                  xstore,ystore,zstore,ifseg,ichunk,npointot, &
