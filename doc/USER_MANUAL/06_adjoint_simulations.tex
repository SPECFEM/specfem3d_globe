...
\begin{figure}[H]
    ...
    \caption{An illustration of computing steady state kernel. Instead of integrating the forward and adjoint wavefields from the beginning, steady state kernel is computed by integrating the wavefields starting from the time when steady state is reached ($t_{ss}$).}
