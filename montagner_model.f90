...
!======================================================================
  ...
  subroutine read_montagner_model(r,theta,phi,beta,pro,npar1,rho,c11,c12,c13,c14,c15,c16, &
  ...
  call exit_MPI(myrank,'Montagner''s model not implemented yet')
  ...
  end subroutine read_montagner_model
...
! dimensionalize
  ...
  if(depth <= pro(nz0) .or. depth >= pro(1)) call exit_MPI(myrank,'r out of range in read_montagner_model')
...
!--------------------------------------------------------------
  ...
  subroutine read_modanis(beta,pro,npar1)

  implicit none

  include "constants.h"

  integer nx,ny,np1,np2,npar1,ipar,ipa1,ipa,ilat,ilon,il,idep,nfin,nfi0,nf,nri
  double precision xinf,yinf,pxy,ppp,angle,A,A2L,AL,af
  double precision ra(47), pro(47), pari(14,37)
  double precision beta(14,34,37,73),bet2(14,34,37,73)
