...
! subroutines to sort MPI buffers to assemble between chunks
  ...
  subroutine sort_array_coordinates(npointot,x,y,z,ibool,icode,iglob,loc,ifseg,nglob,ind,ninseg,iwork,work)
...
! to roundoff errors in the coordinates of the points
  ...
  integer ind(npointot),ninseg(npointot),icode(npointot)
...
! sort within each segment
  ...
  do iseg=1,nseg
    ...
    call swap_all_buffers(ibool(ioff),icode(ioff),loc(ioff), &
...
! -------------------------------------------------------------------
  ...
  subroutine swap_all_buffers(IA,IB,IC,A,B,C,IW,W,ind,n)
!
