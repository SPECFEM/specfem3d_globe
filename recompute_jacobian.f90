...
! check that the parameter file is correct
  if(NGNOD /= 27 .and. .not. SUPPRESS_STOPS_INLINE) stop 'elements should have 27 control nodes'
...
! compute coordinates and jacobian matrix
  ...
  if(jacobian <= ZERO .and. .not. SUPPRESS_STOPS_INLINE) stop '3D Jacobian undefined'
