...
! save header file OUTPUT_FILES/values_from_mesher.h
  ...
  double precision subtract_central_cube_points,static_size,dynamic_size
...
! compute real position of the source
  ...
  if ((dynamic_size+static_size) /= 0.d0) then
    ...
    write(IOUT,*) '! to display here the memory needed for the solver, please run xcreate_header_file'
    write(IOUT,*)
  endif
