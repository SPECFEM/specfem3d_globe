...
! there are twenty-three unique points in the basic doubling brick
  integer, parameter :: NPOINTS = 23
...
! read the basic brick
  open(unit=11,file='dimitri_brick_without_duplicates.dx',status='old',action='read')
