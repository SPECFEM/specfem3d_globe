...
!! DK DK it seems optimal to implement the fourth doubling at this depth in the outer core
  ...
  integer, parameter :: NB_LAYERS_SAMPLING_STUDY = 10
...
! define number of spectral elements and points in basic symmetric mesh doubling superbrick
  integer, parameter :: NSPEC_DOUBLING_SUPERBRICK = 28
  integer, parameter :: NGLOB_DOUBLING_SUPERBRICK = 58
...
!!!!!!!!!!!!!!!  integer, parameter :: NER_BOTTOMDBL_TOPDBL = 6*4
  integer, parameter :: NER_BOTTOMDBL_TOPDBL = 2*4
