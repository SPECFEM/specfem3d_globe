...
! code to check that all the 2D buffers between chunk faces are okay
  ...
  integer icodesend,icodereceive
...
! check all the points based upon their coordinates
  ...
  read(34,*) iboolsend,icodesend,xsend,ysend,zsend
  read(35,*) iboolreceive,icodereceive,xreceive,yreceive,zreceive
...
! fluid/solid: check codes
  if(icodesend /= icodereceive) stop 'error: different codes'
