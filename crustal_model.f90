...
!
  ...
  subroutine get_crust(xlat,xlon,x,vp,vs,rho,moho,found_crust, &
...
!---------------------------
  ...
  subroutine read_3D_crustal_model(abbreviation,code,thlr,velocp,velocs,dens)
...
! local variables
  ...
  end subroutine read_3D_crustal_model
