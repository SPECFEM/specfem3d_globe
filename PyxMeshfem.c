...
static PyObject *__pyx_f_10PyxMeshfem_meshfem3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_v_component = Py_None; Py_INCREF(__pyx_v_component);

  /* "/home/leif/dv/SPECFEM3D_GLOBE/PyxMeshfem.pyx":17 */
  __pyx_1 = PyList_New(1); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; goto __pyx_L1;}
  Py_INCREF(__pyx_n_component);
  PyList_SET_ITEM(__pyx_1, 0, __pyx_n_component);
  __pyx_2 = __Pyx_Import(__pyx_n_PyxParameters, __pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_1 = PyObject_GetAttr(__pyx_2, __pyx_n_component); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; goto __pyx_L1;}
  Py_DECREF(__pyx_v_component);
  __pyx_v_component = __pyx_1;
  __pyx_1 = 0;
  Py_DECREF(__pyx_2); __pyx_2 = 0;

  /* "/home/leif/dv/SPECFEM3D_GLOBE/PyxMeshfem.pyx":18 */
  Py_INCREF(__pyx_v_arg);
  Py_DECREF(__pyx_v_component);
  __pyx_v_component = __pyx_v_arg;

  /* "/home/leif/dv/SPECFEM3D_GLOBE/PyxMeshfem.pyx":19 */
...
DL_EXPORT(void) initPyxMeshfem(void) {
  ...
  /* "/home/leif/dv/SPECFEM3D_GLOBE/PyxMeshfem.pyx":15 */
  return;
  __pyx_L1:;
