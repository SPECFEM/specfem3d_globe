...
urlpatterns = patterns('',
	...
	(r'^simulations/create/$', 'Specfem3DGlobe.web.Specfem3DGlobe.views.frustration'),
	#(r'^simulations/(?P<object_id>\d+)/$', 'django.views.generic.create_update.update_object', simulation_create_update_args),
	(r'^simulations/(?P<object_id>\d+)/$', 'Specfem3DGlobe.web.Specfem3DGlobe.views.frustration'),
