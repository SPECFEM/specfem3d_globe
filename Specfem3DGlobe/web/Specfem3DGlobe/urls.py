...
urlpatterns = patterns('',
	...
	(r'^simulations/(?P<sim_id>\d+)/status/$', 'Specfem3DGlobe.web.Specfem3DGlobe.views.update_simulation_status'),
	...
	(r'^simulations/(?P<sim_id>\d+)/output.tar.gz$', 'Specfem3DGlobe.web.Specfem3DGlobe.views.output_tar_gz'),
