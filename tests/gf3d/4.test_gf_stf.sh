...
###################################################
#
# Runs test_gf_stf against the HDF5-free build from
# 0.configure.default_make.sh.
#
# No database, no HDF5, no MPI: this is a tier-1 test of the source time
# function operators and the output time axis, and runs on every commit in
