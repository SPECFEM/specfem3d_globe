...
!! DK DK commented this out because d80 is now explicitly honored in v4.0
 subroutine attenuation_lookup_index_v36(i, r)!!!!!!!!!, theta, idoubling, ell_d80, ellipticity_val)
   implicit none
   include 'mpif.h'
   include 'constants.h'
...
!  endif
 ...
 end subroutine attenuation_lookup_index_v36
...
! model_1066a_variables
  ...
  if(REFERENCE_1D_MODEL == REFERENCE_MODEL_PREM) then
     ...
     Qr(:)     = Mak135_V%radius_ak135(:)
     Qmu(:)    = Mak135_V%Qmu_ak135(:)
  else if(REFERENCE_1D_MODEL == REFERENCE_MODEL_1066a) then
     Qr(:)     = M1066a_V%radius_1066a(:)
     Qmu(:)    = M1066a_V%Qmu_1066a(:)
  end if
...
subroutine get_attenuation_model_1D_v36(myrank, prname, iregion_code, tau_s, one_minus_sum_beta, &
...
end subroutine get_attenuation_model_1D_v36


subroutine get_attenuation_model_3D_v36(myrank, prname, one_minus_sum_beta, factor_common, scale_factor, tau_s, vnspec)
  use attenuation_model_variables
  implicit none
  include 'constants.h'
  ...
  do ispec = 1, vnspec
     ...
     enddo
  enddo
end subroutine get_attenuation_model_3D_v36
