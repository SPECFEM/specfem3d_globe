...
! count the total number of sources in the CMTSOLUTION file
    ...
    bcast_int = (/MIN_ATTENUATION_PERIOD,MAX_ATTENUATION_PERIOD,NER_CRUST, &
            ...
            SIMULATION_TYPE,REFERENCE_1D_MODEL,NPROC,NPROCTOT,NEX_PER_PROC_XI,NEX_PER_PROC_ETA/)
...
! broadcast the information read on the master to the nodes
    ...
    call MPI_BCAST(bcast_int,33,MPI_INTEGER,0,MPI_COMM_WORLD,ier)
  ...
  if (myrank /=0) then
    ...
    NPROC = bcast_int(30)
    NPROCTOT = bcast_int(31)
    NEX_PER_PROC_XI = bcast_int(32)
    NEX_PER_PROC_ETA = bcast_int(33)
