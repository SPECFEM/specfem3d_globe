...
! mantle
  do i=1,nglob_crust_mantle
    ...
    vpred_crust_mantle(:,i) = veloc_crust_mantle(:,i) + deltatover2*accel_crust_mantle(:,i)
    veloc_crust_mantle(:,i) = vpred_crust_mantle(:,i)
  enddo
...
! inner core
  do i=1,NGLOB_INNER_CORE
    ...
    vpred_inner_core(:,i) = veloc_inner_core(:,i) + deltatover2*accel_inner_core(:,i)
    veloc_inner_core(:,i) = vpred_inner_core(:,i)
  enddo
...
! for anisotropy and gravity, x y and z contain r theta and phi
  call compute_forces_crust_mantle(ell_d80,minus_gravity_table,density_table,minus_deriv_gravity_table, &
          ...
          alphaval,betaval,gammaval,factor_common,update_dof_crust_mantle,nglob_crust_mantle)
  ...
  call compute_forces_inner_core(minus_gravity_table,density_table,minus_deriv_gravity_table,iter, &
          ...
          alphaval,betaval,gammaval,factor_common,update_dof_inner_core)
...
!           done with this point
  ...
  do i=1,nglob_crust_mantle
    veloc_crust_mantle(:,i) = vpred_crust_mantle(:,i) + deltatover2*accel_crust_mantle(:,i)
  enddo
  ...
  do i=1,NGLOB_INNER_CORE
    ...
    veloc_inner_core(:,i) = vpred_inner_core(:,i) + deltatover2*accel_inner_core(:,i)
  enddo
...
! compute internal forces in the fluid region
  ...
  call compute_forces_outer_core(time,deltat,two_omega_earth, &
         ...
         nglob_outer_core,update_dof_outer_core)
