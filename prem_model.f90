...
!
  if(r >= 0.d0 .and. r < RICB) then
    if(idoubling /= IFLAG_TOP_INNER_CORE .and. &
       idoubling /= IFLAG_TOP_INNER_CORE_LEV2 .and. &
...
!
    ...
    if(idoubling /= IFLAG_OUTER_CORE_NORMAL .and. idoubling /= IFLAG_TOP_OUTER_CORE .and. idoubling /= IFLAG_TOP_OUTER_CORE_LEV2 &
    .and. idoubling /= IFLAG_BOTTOM_OUTER_CORE .and. idoubling /= IFLAG_BOTTOM_OUTER_CORE_LEV2) &
      call exit_MPI(myrank,'wrong doubling flag for outer core point')
!
!--- D" at the base of the mantle
!
  else if(r > RCMB .and. r < RTOPDDOUBLEPRIME) then
    if(idoubling /= IFLAG_BOTTOM_MANTLE .and. idoubling /= IFLAG_BOTTOM_MANTLE_LEV2 .and. idoubling /= IFLAG_MANTLE_NORMAL) &
      call exit_MPI(myrank,'wrong doubling flag for D" point')
!
!--- mantle: from top of D" to d670
!
  else if(r > RTOPDDOUBLEPRIME .and. r < R670) then
    if(idoubling /= IFLAG_BOTTOM_MANTLE_LEV2 .and. idoubling /= IFLAG_MANTLE_NORMAL .and. idoubling /= IFLAG_DOUBLING_670) &
